...
public enum UserState {
    ...
    ADMIN_BROADCAST_CHOOSE_TYPE,      // Xabar turini tanlashni kutish
    ADMIN_BROADCAST_AWAITING_TEXT,      // Xabar matnini kutish
    ADMIN_BROADCAST_AWAITING_PHOTO,     // Xabar rasmini kutish
    ADMIN_BROADCAST_AWAITING_TARGETS; // Kimlarga yuborishni kutish
