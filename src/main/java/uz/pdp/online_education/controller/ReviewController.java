    ...
    public class ReviewController {
        ...
        @PostMapping
        @Operation(summary = "Create review", description = "Create a new review for a course by the authenticated student")
        ...
        @GetMapping("/{id}")
        @Operation(summary = "Get review by ID", description = "Retrieve review details by its ID")
        ...
        @GetMapping
        @Operation(summary = "Get all reviews", description = "Retrieve all reviews across all courses")
